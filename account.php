...
<head>
  ...
  <title>OurFinances - Dashboard</title>
...
<body id="page-top" class="sidebar-toggled">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">ourFinances</a>
    <!-- SPACE -->
        ...
        <div class="container-fluid" id="main-container">
          ...
          <div class="card text-white bg-dark" style="width: 18rem;">
            <div class="card-body">
              ...
              <h6 class="card-subtitle mb-2 text-muted" id="contaTipo"></h6>
              <p class="card-text" id="contaDono"></p>
            </div>
          </div>
          <br>
          <div class="card text-white bg-dark" style="width: 18rem;">
            <div class="card-body">
              ...
              <p class="card-text" id="saldoTotal"></p>
            </div>
          </div>
        </div>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Igor Iwashita de Oliveira</span>
          </div>
        </div>
      </footer>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="login.php" id="logoutAction">Logout</a>
        </div>
      </div>
    </div>
  </div>
